...
<?php
require('Analyze.php');
$DataArray=array($AntiRagging[1],$StudentGrievance[1],$WomanceGrievance[1],$SCST[1],$RTI[1]);
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="admin_antiragging.php">
...
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
    labels: ['AntiRagging', 'Student Grievance', 'Women Grievance', 'SC/ST Grivance', 'R.T.I. Grievance'],
    datasets: [{
      label: "Sessions",
      lineTension: 0.3,
      ...
      pointHitRadius: 50,
      pointBorderWidth: 2,
      data: [<?php echo $DataArray[0];?>,<?php echo $DataArray[1]; ?>,<?php echo $DataArray[2];  ?>,<?php echo $DataArray[3];  ?>,<?php echo $DataArray[4]; ?>],
    }],
  },
  options: {
    scales: {
